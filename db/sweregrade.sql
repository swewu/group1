-- course MySQL Script generated by MySQL Workbench
-- 02/07/19 13:56:14
...
CREATE TABLE IF NOT EXISTS `sweregrade`.`historygrade` (
  ...
  CONSTRAINT `fk_historygrade_course1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
ALTER TABLE `sweregrade`.`historygrade` 
ADD COLUMN `firstName` VARCHAR(45) NOT NULL AFTER `courseid`,
ADD COLUMN `lastName` VARCHAR(45) NOT NULL AFTER `firstName`,
ADD COLUMN `courseName` VARCHAR(45) NOT NULL AFTER `lastName`,
ADD COLUMN `status` VARCHAR(10) NOT NULL AFTER `courseName`;
